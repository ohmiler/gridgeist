...
- **Release decision before push:** Ready with the recorded visual-inspection gap below.
...
| Commit, push, and post-push observation | Pending | Populate after publication. |
