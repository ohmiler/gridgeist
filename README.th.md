...
2. คัดลอกโฟลเดอร์ `gridgeist/` ชั้นในไปยัง Skills directory ของ Agent ตำแหน่งโฟลเดอร์และวิธีตรวจพบ Skill แตกต่างกันในแต่ละผลิตภัณฑ์ หากไม่แน่ใจให้ดูคู่มือ Skills ของ Agent นั้น
